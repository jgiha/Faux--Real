...
namespace TestApplication
{
    public class BundleConfig
    {
        ...
        {
            bundles.Add(new ScriptBundle("~/bundles/jqwidgets").Include("~/jqwidgets/jqx-all.js"));
      ...
      "~/Content/noUiSlider/css/nouislider.css"
      , "~/Content/noUiSlider/css/nouislider.min.css"));
